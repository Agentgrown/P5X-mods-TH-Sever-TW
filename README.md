...
<br>
  ---อัพเดต---  
  >เนื้อเรื่องใหม่ Chapter 5 ใช้ gemini แปลมีหลุดบ้างกับในไฟล์มีที่ gemini มันหลอนทำให้มี เว้นบรรทัด แล้ว เอาแปล engมาไทยมาแทน(ไม่มีผลการแปลในเกม แต่แค่ขนาดไฟล์เพิ่มนิดหน่อย เวลาเข้าเกมจะนานกว่าปกติ)  
  >ถ้าอยากใช้ตัว translate อื่นนอกจาก googletranslateV2 ให้ทำการแก้ใน \BepInEx\config จะมีให้เลือกว่าจะเลือกตัวไหนมาแปล ปล.จากที่ผมลองเทสมาแนะนำให้ใช้ Custom แล้วทำ proxy จาก python เขียนให้เชื่อมโมเดลไม่ก็ตัวแปลต่างๆง่ายๆ แค่ใช้ API Key  
  เพราะตัวอื่นผมใช้ไม่ work
  >ถ้าลองใช้แล้วภาษาใน game ไม่เปลี่ยนให้ทำการเปลี่ยน Regional format เป็น Taiwan (แนะนำให้เปลี่ยนเป็น Recommended เพราะจะได้ไม่ต้องเปลี่ยน ไปเปลี่ยนมาเวลาเล่นเกม)
<br>
<br>  
  ---วิธีลง---  
